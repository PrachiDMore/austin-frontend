...
const RulesAndRegulationsPage = ({ checked, setChecked, showModal, setShowModal }) => {
	const navigate = useNavigate();
	return (
		<>
			<Navbar />
			<section className='w-screen min-h-screen Nunito p-10 px-20'>
				<form onSubmit={(e) => {
					e.preventDefault();
					if (!checked) {
					...
					<Button text='Go back' type='button' onClick={() => {navigate(-1)}} />
				</form>
			</section>
		</>
	)
