...
const IndividualDisplayAttendance = ({ showModal, setShowModal, setMessage }) => {
			...
			<div className="relative p-4 w-[70vw] h-auto">
				<div className="relative p-4 bg-white rounded-lg shadow-md shadow-purpleShadow dark:bg-white-800 sm:p-5">
					...
					<div className={displayState === 0 ? 'grid grid-cols-2 gap-x-6 gap-y-4' : "hidden"} >
						<Input readOnly={true} label={"Batch Name"} placeholder={"Batch name"} value={showModal?.data?.individualBatch?.name} />
...
export default IndividualDisplayAttendance
